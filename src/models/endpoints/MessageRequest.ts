...
export interface MessageRequest {
  ...
  notes?: MessageNotes;
  /**
   * Additional information to pass into the instruction flow. This data could then be
   * use in the url or body of a REST API step, influence Chat API's assessment
   * in a conditional step, or help construct a reply with additional details.
   *
   * @remarks
